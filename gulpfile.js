...
let webConfig = {
    entry: {
        ...
        'auth': './app/js/auth.min.js',
        'private': './app/js/private.min.js',
        'test-page-auth': './app/js/test.min.js',
        'test-page-auth-first': './app/js/test-first.min.js',
        'test-page-auth-last': './app/js/test-last.min.js',
        'test-page-no-auth': './app/js/test-no-auth.min.js',
        'test-page-no-auth-first': './app/js/test-no-auth-first.min.js',
        'test-page-no-auth-last': './app/js/test-no-auth-last.min.js'
    },
    output: {
